...
const copy = {
  de: {
    ...
    contact: {
      ...
      text: 'Claimo ist eine moderne Rewards-App mit einer klaren, nutzerfreundlichen Plattform für Spiele, Angebote und Umfragen. Wir sind offen für die Zusammenarbeit mit Offerwall- und Survey-Partnern.',
  ...
  en: {
    ...
    contact: {
      ...
      text: 'Claimo is a modern rewards app with a clear and user-friendly platform for games, offers and surveys. We are open to working with offerwall and survey partners.',
      cta: 'Contact us',
    },
    footer: {
      slogan: 'Rewards made simple.',
    ...
    <>
      ...
      <section id="rewards" className="rewards-section shell" aria-labelledby="rewards-title">
        <div className="rewards-copy">
          <span className="rewards-eyebrow"><img src="/gems.png" alt="" />{t.rewards.eyebrow}</span>
